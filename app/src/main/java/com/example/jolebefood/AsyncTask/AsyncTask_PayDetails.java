...
public class AsyncTask_PayDetails extends AsyncTask<Void,CartDTO,Void> {
    ...
    public AsyncTask_PayDetails(RecyclerView recyclerView, ProgressBar progressBar, Context context, ArrayList<CartDTO> datalist) {
    ...
    protected void onPreExecute() {
        adapter = new Pay_Details_Item(listTemp);
